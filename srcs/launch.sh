...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2020/05/05 11:35:08 by atrouill          #+#    #+#              #
#    Updated: 2020/05/05 11:35:15 by atrouill         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
tail -f /var/log/nginx.log | ccze -A & wait ${!}
